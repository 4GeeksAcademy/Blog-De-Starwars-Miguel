            ...
            <div className="container">
                ...
                <div className="card col-md-12 border-0 " >
                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-center">
                        ...
                        <div className="m-3 col-md-auto">
                            <span className="text-danger"><b>Model</b></span>   
                            <p className="text-danger">{store.learnMoreObject.model}</p>
                        </div>

                        <div className="m-3 col-md-auto">
                            <span className="text-danger"><b>Manufacturer</b></span>   
                            <p className="text-danger">{store.learnMoreObject.manufacturer}</p>
                        </div>

                        <div className="m-3 col-md-auto">
                            <span className="text-danger"><b>Crew</b></span>   
                            <p className="text-danger">{store.learnMoreObject.crew}</p>
                        </div>

                        <div className="m-3 col-md-auto">
                            <span className="text-danger"><b>Cost in Credits</b></span>   
                            <p className="text-danger">{store.learnMoreObject.cost_in_credits}</p>
                        </div>

                        <div className="m-3 col-md-auto">
                            <span className="text-danger"><b>Length</b></span>   
                            <p className="text-danger">{store.learnMoreObject.length}</p>
                        </div>
                    </div>
                </div>
